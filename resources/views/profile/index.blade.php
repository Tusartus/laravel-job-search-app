...
<div class="container">
    <div class="row">
        <div class="col-md-3">
            ...
            <img src="{{asset('avatar/default.png')}}" width="100" style="width: 100%;">
            @else
            <img src="{{ url('storage/uploads/avatar/'.Auth::user()->profile->avatar)}}" width="100" style="width: 100%;">
        ...
        <div class="col-md-4">
          ...
          @if(!empty(Auth::user()->profile->cover_letter))
              <p><a href="{{url('storage/letters/'.Auth::user()->profile->cover_letter)}}">Cover letter</a></p>
          @else
          ...
          @if(!empty(Auth::user()->profile->resume))
              <p><a href="{{url('storage/files/'.Auth::user()->profile->resume)}}">Resume</a></p>
          @else
