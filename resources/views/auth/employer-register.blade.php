       ...
       @if(Session::has('message'))
          ...
          <div class="col-md-12 col-lg-8 mb-5">
            ...
            <form method="POST" action="" class="p-5 bg-white">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="name" type="text" placeholder="Company name" class="form-control{{ $errors->has('cname') ? ' is-invalid' : '' }}" name="cname" value="{{ old('cname') }}" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="password" type="password" placeholder="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" value="{{ old('password') }}">
          ...
          <div class="col-lg-4">
            ...
            <div class="p-4 mb-3 bg-white">
                 ...
                 <p>Already have an acount as employer</p>
                 <p><a href="{{ route('login') }}" class="btn btn-primary  py-2 px-4">Login here</a></p>
               </div>
